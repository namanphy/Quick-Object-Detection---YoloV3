...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/yolov3-HardhatVestMaskBoots.cfg', help='*.cfg path')
    parser.add_argument('--names', type=str, default='data/HardhatVestMaskBoots/HardhatVestMaskBoots.names', help='*.names path')
